...
import com.gensagames.linkedlistview.sample.SimplePointPagerAdapter;
...
public class ActivitySimplePointMoving extends Activity implements View.OnClickListener,
    ...
    private SimplePointPagerAdapter pagerAdapter;
    ...
    private void setupPointData() {
        ...
        animationController = new SimplePointPagerAdapter.AnimationController();
