...
public class DefaultSize {
    ...
    public static final int POINT_ANIM_TIME = 250;
    ...
    /**
     * Simple Size for default CenterMotionAdapter
     */

    public static final int CENTER_MOTION_PARENT = 60;
    public static final int CENTER_MOTION_CIRCLE = 50;

    /**
     * Simple Size for default Line between View
     */
    public static final int SIZE_LINE_WIDTH = 30;
    public static final int SIZE_LINE_HEIGHT = 5;


    /**
     * Animation Scrolling to view index
     */
    public static final int SCROLL_ANIM_DURATION = 400;
}
